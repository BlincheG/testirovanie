...
class CartItemsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create cart_item" do
    assert_difference('CartItem.count') do
      post cart_items_url, params: { cart_item: { count: @cart_item.count, food_id: @cart_item.food_id, name: @cart_item.name, price: @cart_item.price } }
    end
  ...
  test "should update cart_item" do
    patch cart_item_url(@cart_item), params: { cart_item: { count: @cart_item.count, food_id: @cart_item.food_id, name: @cart_item.name, price: @cart_item.price } }
